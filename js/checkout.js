...
function getTotalPrice(burgerName, burgerPrice){
  var saveQuantity = localStorage.getItem(burgerName);
  if(saveQuantity === undefined){
    return 0
  }else{
    return saveQuantity * burgerPrice
  }
}
...
function clearAll(event) {
  ...
  var prices0 = getTotalPrice("Cheeseburger",products.cheeseburger.price);
  var prices1 = getTotalPrice("Lot Burger",products.cheeseburger.price);
  var prices2 = getTotalPrice("FriedChickenBurger1",products.cheeseburger.price);
  var prices3 = getTotalPrice("FriedChickenBurger2",products.cheeseburger.price);
  var prices4 = getTotalPrice("VeganBurger",products.cheeseburger.price);
  var prices5 = getTotalPrice("Chips",products.cheeseburger.price);
  var prices6 = getTotalPrice("SoftDrink",products.cheeseburger.price);

  // if(prices0 || prices1 || prices2 || prices3 || prices4 || prices5 || prices6 == NaN){
  //   var prices0 ="";
  //   var prices1 ="";
  //   var prices2 ="";
  //   var prices3 ="";
  ...
  // }
  console.log(prices1);
  var total = parseInt(prices0) + parseInt(prices1) + parseInt(prices2) + parseInt(prices3) + parseInt(prices4) + parseInt(prices5) + parseInt(prices6);
  console.log(total);
  // localStorage.clear();
  var addImage = $("<section>", {
    class: "menuRow",
